...
const SiteHeader = () => {
  ...
  function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    // TODO: Fix!
    //  (formRef.current! as React.FormEvent<HTMLFormElement>).clear();


    // pull out the value of the input field (q)

    // useNavigate() to send user to /{locale}/search?q={value}
      ...
      <nav className="bg-white border-gray-200 -mb-3">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl py-4 px-6">
          <div className="flex items-center">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="w-50 flex justify-center md:justify-between">
              <div className="relative">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="block w-50 md:w-80 h-9 p-4 pl-10 text-xs text-gray-900 border-0 bg-gray-100 focus:ring-white placeholder-gray-700"
